...
public class InstallInstallAction extends AbstractAction {
	...
	protected void executeInternal(StateContext<SkipperStates, SkipperEvents> context) {
		...
		if (installRequest == null) {
			installRequest = context.getExtendedState().get(SkipperEventHeaders.INSTALL_REQUEST, InstallRequest.class);
		}
		...
		if (installProperties == null) {
			installProperties = context.getExtendedState().get(SkipperEventHeaders.INSTALL_PROPERTIES,
					InstallProperties.class);
		}
