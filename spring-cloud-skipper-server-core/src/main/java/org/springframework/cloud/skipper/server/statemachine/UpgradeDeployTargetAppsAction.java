...
//		this.upgradeStrategy.upgrade(releaseAnalysisReport.getExistingRelease(), releaseAnalysisReport.getReplacingRelease(), releaseAnalysisReport);
//		List<String> applicationNamesToUpgrade = this.deployAppStep.deployApps(
//				releaseAnalysisReport.getExistingRelease(), releaseAnalysisReport.getReplacingRelease(),
